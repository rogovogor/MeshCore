...
```
+-------+-------+-----------------------+---------------------------+-------------------------------------+------------------------+----------------+
| nRF52 | Pin   | LORA (E22/E22P/RA-62) | Epaper 2.13" (SPI1)       | Input (UI)                          | Output                 | GPS            |
+-------+-------+-----------------------+---------------------------+-------------------------------------+------------------------+----------------+
| GND   | GND   |                       | GND                       |                                     |                        | GND            |
| GND   | GND   |                       | GND                       |                                     |                        | GND            |
| P0.08 | D0    |                       |                           | UART RX (Serial1) ← GPS TX          |                        |                |
| P0.06 | D1    |                       |                           | UART TX (Serial1) → GPS RX          |                        |                |
| P0.17 | D2    |                       |                           |                                     | GPS ENABLE (HIGH=on)   |                |
| P0.20 | D3    |                       |                           | ENCODER LEFT (A)                    |                        |                |
| P0.22 | D4    |                       |                           | ENCODER RIGHT (B)                   |                        |                |
| P0.24 | D5    |                       | CS (chip select)          |                                     |                        |                |
| P1.00 | D6    |                       |                           | BUTTON BACK / BOOT (INPUT_PULLUP)   |                        |                |
| P0.11 | D7    |                       | RST (reset)               |                                     |                        |                |
| P1.04 | D8    |                       | BUSY (status)             |                                     |                        |                |
| P1.06 | D9    |                       |                           | ENCODER PRESS / SW (INPUT_PULLUP)   |                        |                |
+-------+-------+-----------------------+---------------------------+-------------------------------------+------------------------+----------------+
| P0.09 | D10   | NRESET (reset)        |                           |                                     |                        |                |
| P0.10 | D11   | DIO1 (IRQ)            |                           |                                     |                        |                |
| P1.11 | D12   |                       | DC (data/command)         |                                     |                        |                |
| P1.13 | D13   | NSS / CS (SPI)        |                           |                                     |                        |                |
| P1.15 | D14   | SCK (clock)           | [SPI1 SCK = D18]          |                                     |                        |                |
| P0.02 | D15   | MOSI (data out)       | [SPI1 MOSI = D20]         |                                     |                        |                |
| P0.29 | D16   | MISO (data in)        |                           |                                     |                        |                |
| P0.31 | D17   |                       |                           | ADC (AIN7) ← VBAT divider           |                        |                |
+-------+-------+-----------------------+---------------------------+-------------------------------------+------------------------+----------------+
| 3V3   | 3V3   | VCC (via VCC_EN)      | VCC                       |                                     |                        | VCC (3V3/5V)   |
| P0.13 | D21   | VCC_EN (enable)       |                           |                                     |                        |                |
| RST   | RST   |                       |                           |                                     |                        |                |
| GND   | GND   |                       | GND                       |                                     |                        | GND            |
+-------+-------+-----------------------+---------------------------+-------------------------------------+------------------------+----------------+
| P1.01 | D18   |                       | SCK (clock) [SPI1]        |                                     |                        |                |
| P1.02 | D19   | BUSY (status, GPIO)   | [было: SPI1 MISO unused]  |                                     |                        |                |
| P1.05 | D20   |                       | MOSI (data) [SPI1]        |                                     |                        |                |
+-------+-------+-----------------------+---------------------------+-------------------------------------+------------------------+----------------+
...
- **SPI** (D14/D15/D16) — независимая шина для радио E22/E22P/RA-62.
- **SPI1** (D18/D20) — независимая шина для дисплея. MISO не используется (дисплей write-only).
